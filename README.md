...
*If the program does not start, check the logfile.log file for errors. Your computer's system time may be out of sync. If an error occurs, for example, Windows users should check the “Date and Time” settings: in the “Synchronize clocks” section, you must click the “Sync now” button.*
