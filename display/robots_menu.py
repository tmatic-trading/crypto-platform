...
class CustomButton(tk.Menubutton):
    ...
    def open_popup(self, title, content):
        ...
        if is_syntax_correct:
            ...
            tk.Label(top, text=f"The code has an error: {error_message}").place(x=150, y=80)
...
class SettingsApp:
    ...
    def create_right_frames(self):
        ...
        self.bot_strategy_text = tk.Text(self.bot_strategy, highlightthickness=0, yscrollcommand=self.bot_strategy_scroll.set)
